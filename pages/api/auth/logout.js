async function handleLogout(req, res) {
  ...
  // res.redirect(`https://${process.env.COGNITO_DOMAIN}/logout?response_type=code&client_id=${process.env.COGNITO_CLIENT_ID}&logout_uri=${process.env.COGNITO_LOGOUT_URL}&redirect_uri=${process.env.COGNITO_LOGOUT_REDIRECT_URL}`);
